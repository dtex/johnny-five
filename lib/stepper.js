...
function Stepper(opts) {
  ...
  this.targetSpeed = typeof opts.speed !== "undefined" ?
    opts.speed : 1;
  this.currentDirection = typeof opts.direction !== "undefined" ?
    opts.direction : 1;
...
/*
 * Calculate acceleration, deceleration and cruise time for stepper movement
 */
Stepper.prototype.planSteps = function() {
  ...
  let steps = Math.abs(this.absoluteTarget - this.absolutePosition);
  ...
  accelTable.forEach((delay, index) => {
    tasks.push({
      delay: delay,
      task: () => { 
